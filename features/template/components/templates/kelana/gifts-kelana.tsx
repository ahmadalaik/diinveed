  ...
  return (
    <section className="px-8 py-16 border-b border-[#e5e0d6]">
      ...
      >
        ...
        <p className="mt-3 px-6 text-base text-stone-200 font-serif font-light leading-relaxed">
      ...
      <div className="space-y-6">
        {inv.gifts.map((gift, index) => (
          <GiftCard key={gift.id} delay={index * 0.15}>
            <h4 className="text-xl text-stone-50 mb-6 flex items-center gap-3 font-normal font-serif">
            ...
            <div className="space-y-3 text-sm text-stone-50 tracking-wide">
              ...
              <div className="flex flex-col items-start mb-2">
                ...
                <div className="flex items-center justify-between w-full">
                  ...
                  <CopyButton
                    className="bg-stone-50 hover:bg-[#6b7c62] text-[#2c2c2c] hover:text-stone-50 transition-all duration-500 tracking-wider text-xs uppercase rounded-sm shadow-sm font-medium"
