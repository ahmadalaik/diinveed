          ...
          >
            <div className="w-32 h-32 mb-4 rounded-full overflow-hidden border border-[#d4cbb3] p-1">
              <Image
                ...
                src={
                  inv.brideImage ||
                  "https://res.cloudinary.com/drcvunlct/image/upload/v1777212296/elegant_bride_photo_vw1fkf.webp"
                }
                alt="Bride"
                className="w-full h-full object-cover rounded-full lg:grayscale hover:grayscale-0 transition-all duration-700"
              />
            </div>
            <h3 className="font-script text-3xl text-[#2c2c2c]">
              {inv.brideName}
            </h3>
          ...
          >
            <div className="w-32 h-32 mb-4 rounded-full overflow-hidden border border-[#d4cbb3] p-1">
              <Image
                ...
                src={
                  inv.groomImage ||
                  "https://res.cloudinary.com/drcvunlct/image/upload/v1777212297/elegant_groom_photo_ja0hhq.webp"
                }
                alt="Groom"
                className="w-full h-full object-cover rounded-full lg:grayscale hover:grayscale-0 transition-all duration-700"
              />
