...
export function KalandraCountdown({ inv }: Props) {
      ...
      <div className="relative z-10">
        ...
        >
          <div>
            ...
            <span className="text-[9px] uppercase block mt-1">Hari</span>
          </div>
          <div>
            <span className="text-2xl font-semibold">{timeLeft.hours}</span>
            <span className="text-[9px] uppercase block mt-1">Jam</span>
          </div>
          <div>
            <span className="text-2xl font-semibold">{timeLeft.minutes}</span>
            <span className="text-[9px] uppercase block mt-1">Menit</span>
          </div>
          <div>
            <span className="text-2xl font-semibold">{timeLeft.seconds}</span>
            <span className="text-[9px] uppercase block mt-1">Detik</span>
          </div>
        </motion.div>
        ...
        >
          <Button
            ...
            variant="outline"
            className={cn(
              "bg-transparent border-(--tpl-bg-primary) text-(--tpl-text-primary)",
              // "hover:bg-(--tpl-text-secondary) hover:text-(--tpl-text-tertiary)",
              "text-[10px] tracking-[0.2em] px-6 h-12",
