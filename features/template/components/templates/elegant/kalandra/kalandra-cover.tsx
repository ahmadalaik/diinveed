...
export function KalandraCover({ inv, onOpen, guestName }: Props) {
  ...
  return (
    <section
      className={cn(
        ...
        // "bg-(--tpl-bg-primary)", // uncomment this for apply overlay blend feature
    ...
    >
      ...
      <motion.div
        className="flex flex-col justify-between h-full w-full relative z-10 py-8"
        initial="hidden"
        animate="visible"
        variants={{
          hidden: {},
        ...
        <div className="flex flex-col items-center gap-7">
          ...
          >
            <div className="flex flex-col justify-center">
              <p
                className={cn(
                  "font-light text-xs tracking-[0.25em] drop-shadow-md",
                  "text-(--tpl-text-primary)",
              ...
              <span
                className={cn(
                  "font-(family-name:--tpl-font-heading) font-medium text-3xl italic mt-2 drop-shadow-md text-balance",
                  "text-(--tpl-text-primary)",
                )}
              >
