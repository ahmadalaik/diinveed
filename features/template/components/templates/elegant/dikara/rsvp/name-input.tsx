        ...
        <Field data-invalid={fieldState.invalid}>
          <FieldLabel
            ...
            className={cn(
              ...
              "text-(--tpl-text-primary)/90 group-focus-within:text-(--tpl-btn-bg-secondary)",
            )}
          >
            Nama
          </FieldLabel>
            ...
            <div className="relative group">
              ...
              <Input
                ...
                className={cn(
                  ...
                  "bg-(--tpl-bg-tertiary)/20 text-(--tpl-text-primary) placeholder:text-(--tpl-text-primary)/80 focus-visible:ring-2 focus-visible:ring-(--tpl-btn-bg-secondary)/20",
                )}
