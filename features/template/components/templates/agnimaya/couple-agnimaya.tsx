...
export function CoupleAgnimaya({ inv }: Props) {
  ...
  return (
    <section ref={ref} className="px-8 py-24 border-b border-camel/10 bg-ivory">
      <motion.div
      ...
      <div className="space-y-10">
        ...
        <motion.div
          ...
          variants={fadeUp(0.2)}
        >
          <div className="relative w-40 h-52 mb-6 overflow-hidden rounded-3xl bg-champagne/30">
            <Image
              fill
          ...
          <h3 className="font-serif text-2xl text-espresso mb-2">{inv.brideName}</h3>
          <p className="text-rosegold font-sans text-[10px] tracking-[0.2em] uppercase mb-2">
            The Bride
          </p>
          <p className="font-serif text-sm text-camel italic text-balance">
        ...
        {/* Divider */}
        <motion.div
          className="text-center text-champagne font-serif text-2xl italic"
          initial="hidden"
          animate={isInView ? "visible" : "hidden"}
        ...
        >
          ...
          <h3 className="font-serif text-2xl text-espresso mb-2">{inv.groomName}</h3>
          <p className="text-rosegold font-sans text-[10px] tracking-[0.2em] uppercase mb-2">
            The Groom
          </p>
          <p className="font-serif text-sm text-camel italic text-balance">
